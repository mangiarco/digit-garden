...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 2em;">
  ...
  <div>
    <h3>Hello there</h3>
    <p>
      Welcome in my digital garden🪴 a virtual place where I periodically store all kinds of information that I encounter throughout my life.
    </p>
  </div>
...
- Notes are taken with [Obsidian](https://obsidian.md/), one of the most versatile and powerful free note-taking application